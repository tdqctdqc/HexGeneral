...
public class Unit(int id, ERef<Regime> regime, float currentHitPoints, float currentOrganization, float currentAmmo, ModelIdRef<UnitModel> unitModel) : Entity(id)
{
